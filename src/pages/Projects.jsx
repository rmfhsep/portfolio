      ...
      <div className="container p-16 flex relative min-h-screen">
        <div className="w-full flex flex-col relative z-20">
          ...
          <div className="w-full flex flex-col justify-center mt-10">
            <div className="flex box-border w-full p-3.5 bg-gray-700 rounded-md shadow-md shadow-light/10">
              <div className="w-3/5 box-border flex justify-center items-center">
              ...
              <div className="w-2/5">
                <div className="mt-4">
                  <p className="text-indigo-400 font-semibold">Team Project</p>
                  <p className="text-white text-4xl font-bold">moongori</p>
                  ...
                  <div className="flex items-center mt-4">
                    ...
                    <p
                      style={{ color: "#a2a1a6" }}
                      className="ml-2 text-sm sm:text-base font-semibold tracking-wide"
                    >
                      React
                    </p>
                  ...
                  <p style={{ color: "#a2a1a6" }} className="text-sm mt-10">
                    기존 중고거래의 불편함을 해소하기 위한 경매 플랫폼
                  </p>
                  <div className="flex">
                    <a>
