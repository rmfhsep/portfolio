      ...
      <div className="container p-16 flex relative min-h-screen">
        <div className="flex flex-col relative z-20">
          ...
          <div className="w-full flex justify-center">
            <div className="w-full grid gap-12 grid-cols-4 sm:grid-cols-5 mt-4">
              <div className="items-center flex justify-start p-0 flex-col mb-4 mr-0 h-28 sm:h-auto">
                <div className="w-20 sm:w-32 h-16 sm:h-20 group transition-all duration-200 ease-in-out transform translate-y-0 group hover:-translate-y-0 translate-x-0">
                ...
                <p className="mt-6 sm:mt-14 text-sm sm:text-base font-semibold tracking-wide opacity-100 normal-case text-center">
                  HTML
                </p>
              </div>
              <div className="items-center flex justify-start p-0 flex-col mb-4 mr-0 h-28 sm:h-auto">
                <div className="w-20 sm:w-28 h-16 sm:h-20 group transition-all duration-200 ease-in-out transform translate-y-0 group hover:-translate-y-0 translate-x-0">
                  <svg viewBox="0 0 128 128">
                    <path
                      className="dark:text-light text-mid transition-all duration-200 ease-in-out fill-current"
                ...
                <p className="mt-4 text-sm sm:text-sm font-semibold tracking-wide opacity-100 normal-case text-center">
                  CSS
                </p>
              </div>
              <div className="items-center flex justify-start p-0 flex-col mb-4 mr-0 h-28 sm:h-auto">
              ...
              <div className="items-center flex justify-start p-0 flex-col mb-4 mr-0 h-28 sm:h-auto">
                <div className="w-20 sm:w-28 h-16 sm:h-20 group transition-all duration-200 ease-in-out transform translate-y-0 group hover:-translate-y-0 translate-x-0">
                  <svg viewBox="0 0 128 128">
                    <path
                      class="dark:text-light text-mid transition-all duration-200 ease-in-out fill-current"
              ...
              <div className="items-center flex justify-start p-0 flex-col mb-4 mr-0 h-28 sm:h-auto">
                ...
                <p class="mt-4 text-sm sm:text-sm font-semibold tracking-wide opacity-100 normal-case text-center">
                  Photoshop
                </p>
              </div>
            </div>
